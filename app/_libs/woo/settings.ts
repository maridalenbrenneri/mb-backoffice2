...
export const MB_PRODUCT_CODE_ATTRIBUTE_NAME = 'mb-product-code';
...
export const WOO_STATUS_PROCESSING = 'processing';
export const WOO_STATUS_ACTIVE = 'active';
export const WOO_STATUS_ON_HOLD = 'on-hold';
