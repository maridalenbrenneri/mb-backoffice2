...
import { generatePreview } from '~/_services/packing-service';
...
export const loader = async ({ request }: { request: Request }) => {
  ...
  const currentDeliveries = await deliveryService.getDeliveries({
    select: {
      id: true,
      date: true,
      type: true,
  ...
  const selectedDelivery = deliveryId
    ...
    : await deliveryService.getNextOrCreateDelivery();
